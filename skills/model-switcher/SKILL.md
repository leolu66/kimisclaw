...
双击桌面上的 **"Model Switcher.lnk"** 即可启动模型切换器。
...
可用模型列表:
--------------------------------------------------------------------------------
   1. WhaleCloud MiniMax-M2.5                  whalecloud/MiniMax-M2.5         [当前使用]
   2. Moonshot Kimi-K2.5                       moonshot/kimi-k2.5            
   3. WhaleCloud GLM-4.7                       whalecloud/glm-4.7            
   4. WhaleCloud Kimi-K2.5                     whalecloud/kimi-k2.5          
   5. WhaleCloud Doubao-Pro                    whalecloud/doubao-seed-2.0-pro
   6. WhaleCloud Doubao-Mini                    whalecloud/doubao-seed-2.0-mini
   7. WhaleCloud Doubao-Lite                    whalecloud/doubao-seed-2.0-lite
   8. WhaleCloud Claude-4.5-Sonnet             whalecloud/claude-4.5-sonnet  
   9. WhaleCloud Claude-4.5-Haiku               whalecloud/claude-4.5-haiku   
  10. Zhipu GLM-4.7                            zhipu/glm-4.7                 
--------------------------------------------------------------------------------
当前使用: WhaleCloud MiniMax-M2.5 (whalecloud/MiniMax-M2.5)
================================================================================
```
